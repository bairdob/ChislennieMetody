...
void calc_answer_new(double arr_b[3][4],int n,int m,double arr_ans1[3],double arr_ans2[3]){
	arr_ans2[0] = arr_b[0][0]*arr_ans2[0] + arr_b[0][1]*arr_ans2[1]+arr_b[0][2]*arr_ans1[2]+arr_b[0][3];
	arr_ans2[1] = arr_b[1][0]*arr_ans2[0] + arr_b[1][1]*arr_ans2[1]+arr_b[1][2]*arr_ans1[2]+arr_b[1][3];
	arr_ans2[2] = arr_b[2][0]*arr_ans2[0] + arr_b[2][1]*arr_ans2[1]+arr_b[2][2]*arr_ans1[2]+arr_b[2][3];
}
