...
void arr_show(double arr[5][7],int n,int m){
...
double calc_koef_p (double arr[5][7],int n,int m, double &p, int iteration){
	double p_i_plus_one;
	double c, b, a;
	int i = iteration;
...
double calc_koef_q (double arr[5][7],int n,int m, double &p, double &q,int iteration){
	double q_i_plus_one;
	double d, b, a;
	int i = iteration;
...
int main(){
	const int n = 5; //example Cherkasov page13
	const int m = 7; 
	double arr[n][m] = {{0, -34, -26, 0, 0, 0, 34}, 
						{0, 64, -124, -56, 0, 0, 38},
						{0, 0, 94, -274, -86, 0, 42},
						{0, 0, 0, 124, -484, -116, 46},
						{0, 0, 0, 0, 154, -754, 50}};
	double arr_p[m-1] = {0};
	double arr_q[m-1] = {0};
